...
terria.start({
    ...
    try {
        ...
        var createCustomGlobalBaseMapOptions = require('./lib/ViewModels/createCustomGlobalBaseMapOptions');
        var selectBaseMap = require('terriajs/lib/ViewModels/selectBaseMap');

        //var australiaBaseMaps = createAustraliaBaseMapOptions(terria);
        var globalBaseMaps = createCustomGlobalBaseMapOptions(terria, terria.configParameters.bingMapsKey);
